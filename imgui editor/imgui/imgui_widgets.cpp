...
bool    ImGui::BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect& tab_bar_bb, ImGuiTabBarFlags flags)
{
    ...
    // Layout
    ItemSize(ImVec2(tab_bar->OffsetMaxIdeal, tab_bar->BarRect.GetHeight()), tab_bar->FramePadding.y - 5);
    ...
    const float y = tab_bar->BarRect.Max.y - 1.0f;
    {
        ...
        window->DrawList->AddLine(ImVec2(separator_min_x, y), ImVec2(separator_max_x - 6, y), ImColor(120, 120, 120), 1.0f);
    }
    return true;
}
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags)
{
    ...
    const ImU32 tab_col = (held || hovered) ? ImColor(120, 120, 120, 255) : tab_contents_visible ? (tab_bar_focused ? ImColor(120, 120, 120, 255) : ImColor(120, 120, 120, 255)) : (tab_bar_focused ? ImColor(60, 60, 60,255) : ImColor(120, 120, 120, 255));
